...
describe("generate", () => {
  ...
  describe("complex types", () => {
    ...
    it("should handle complex type derivations and dependencies from const objects", () => {
      const sourceText = `
export const MY_CONST_VALUES = {
  ALPHA: 'alpha_value',
  BETA: 'beta_value',
  GAMMA: 123,
} as const;

export type MyConstType =
  (typeof MY_CONST_VALUES)[keyof typeof MY_CONST_VALUES];

export const ANOTHER_CONST_VALUES = {
  DELTA: 'delta_value',
  EPSILON: true,
} as const;

export type AnotherConstType = (typeof ANOTHER_CONST_VALUES)[keyof typeof ANOTHER_CONST_VALUES];

export type CombinedConstType = MyConstType | AnotherConstType;

export type DetailItem = {
  id: string;
  kind: CombinedConstType;
  description?: string;
};

export type MainItem = {
  item_type: MyConstType;
  details?: DetailItem[];
  is_active: boolean;
};

export type ResponseList = MainItem[];
  `;
...
export const myConstTypeSchema = z.union([z.literal("alpha_value"), z.literal("beta_value"), z.literal("123")]);

export const anotherConstTypeSchema = z.union([z.literal("delta_value"), z.literal("true")]);

export const combinedConstTypeSchema = z.union([myConstTypeSchema, anotherConstTypeSchema]);

export const detailItemSchema = z.object({
    id: z.string(),
    kind: combinedConstTypeSchema,
    description: z.string().optional()
});

export const mainItemSchema = z.object({
    item_type: myConstTypeSchema,
    details: z.array(detailItemSchema).optional(),
    is_active: z.boolean()
});

export const responseListSchema = z.array(mainItemSchema);
"
`);
    });
    it("should handle complex type derivations and dependencies from const objects with enums", () => {
      const sourceText = `
export type Cause = {
  code: CauseCode;
};
...
export type CauseCode =
  | BlockingErrors
  | SupportFixableErrors
  | SpecialErrors
  | ManuallyFixableErrors;
...
export type BlockingErrors = (typeof BLOCKING_ERRORS)[keyof typeof BLOCKING_ERRORS];

export const SUPPORT_FIXABLE_ERRORS = {
  C: 'C',
  D: 'D',
} as const;

export type SupportFixableErrors =
  (typeof SUPPORT_FIXABLE_ERRORS)[keyof typeof SUPPORT_FIXABLE_ERRORS];

export const SPECIAL_ERRORS = {
  E: 'E',
} as const;

export type SpecialErrors = (typeof SPECIAL_ERRORS)[keyof typeof SPECIAL_ERRORS];

export const MANUALLY_FIXABLE_ERRORS = {
  F: 'F',
  G: 'G',
  H: 'H',
  I: 'I',
...
export type ManuallyFixableErrors =
  (typeof MANUALLY_FIXABLE_ERRORS)[keyof typeof MANUALLY_FIXABLE_ERRORS];
`;
...
export const blockingErrorsSchema = z.union([z.literal("A"), z.literal("B")]);

export const supportFixableErrorsSchema = z.union([z.literal("C"), z.literal("D")]);

export const specialErrorsSchema = z.literal("E");

export const manuallyFixableErrorsSchema = z.union([z.literal("F"), z.literal("G"), z.literal("H"), z.literal("I")]);

export const causeCodeSchema = z.union([blockingErrorsSchema, supportFixableErrorsSchema, specialErrorsSchema, manuallyFixableErrorsSchema]);

export const causeSchema = z.object({
    code: causeCodeSchema
});
"
`);
    });
  ...
  it('should handle (typeof MyConst)[keyof typeof MyConst] for string values with "as const" syntax', () => {
    const sourceText = `export const STRING_A = 'STRING_A';
        export const STRING_B = 'STRING_B';
        export const STRING_C = 'STRING_C';
        export const STRING_D = 'STRING_D';

        export const CLASS = { STRING_A, STRING_B, STRING_C, STRING_D } as const;

        export type InstrumentClass = (typeof CLASS)[keyof typeof CLASS];
    `;
...
export const instrumentClassSchema = z.union([z.literal("STRING_A"), z.literal("STRING_B"), z.literal("STRING_C"), z.literal("STRING_D")]);
"
`;
  ...
  it("should handle nested const objects with union types", () => {
    const sourceText = `export const OBJECT_A = {
  A: 'A',
  B: 'B',
  C: 'C',
  D: 'D',
...
export type ObjectA = (typeof OBJECT_A)[keyof typeof OBJECT_A];

export const OBJECT_B = {
  [OBJECT_A.A]: OBJECT_A.A,
  [OBJECT_A.B]: OBJECT_A.B,
  [OBJECT_A.D]: OBJECT_A.D,
} as const;

export type ObjectB =
  (typeof OBJECT_B)[keyof typeof OBJECT_B];`;
...
export const objectASchema = z.union([z.literal("A"), z.literal("B"), z.literal("C"), z.literal("D"), z.literal("E")]);

export const objectBSchema = z.union([z.literal("A"), z.literal("B"), z.literal("D")]);
"
`);
  });
});
